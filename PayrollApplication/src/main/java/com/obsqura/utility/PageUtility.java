...
public class PageUtility {
	...
	/*public void dropDown6(String value6)
		...
		public void logOutClick(WebDriver driver, WebElement element)
		{
		...
		public WebElement waitForElementTobeClickable(WebDriver driver, WebElement elementToBeLoaded, int Time) {
	        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));//new WebDriverWait(driver, Duration.ofSeconds(10));
