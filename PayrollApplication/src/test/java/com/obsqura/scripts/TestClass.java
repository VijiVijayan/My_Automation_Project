...
public class TestClass extends TestBase {
	...
	@Test(priority=1)
	public void verifyLogin_with_incorrectUsername_and_incorrectpassword() throws IOException
	{
		obj=new LoginPage(driver);
		synchronized(obj) {
			try {
	...
	public void verifyLogout_inCarolThomasButton()
	{
		...
		obj5.carolThomasButton();
		obj5.logOut();
		//obj2.logOutClick(driver, logout);
		String actualTitle=driver.getTitle();
		String expectedTitle=constants.TITLE;
		Assert.assertEquals(actualTitle, expectedTitle);
	...
	@Test(priority=20)
	public void verify_searchbutton_with_ValidClientNameandId() throws IOException
	{
	...
	public void verify_CreateNewWorkerButton() throws InterruptedException
	{
		...
		obj3.dropDown7(dropgender);
		String workerbranch= ExcelUtility.getCellData(35,0);
		obj3.dropDown8(workerbranch);
